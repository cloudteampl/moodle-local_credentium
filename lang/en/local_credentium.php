...
$string['globalcredentials_available_desc'] = 'This category will use the global Credentium API credentials configured in Site Administration > Plugins > Local plugins > Credentium® Integration.';
$string['globalcredentials_notavailable'] = 'Global API credentials are not configured';
$string['globalcredentials_notavailable_desc'] = 'Global API credentials have not been configured. You must either configure them in Site Administration > Plugins > Local plugins > Credentium® Integration, or select "Use custom API credentials" above and configure category-specific credentials.';
